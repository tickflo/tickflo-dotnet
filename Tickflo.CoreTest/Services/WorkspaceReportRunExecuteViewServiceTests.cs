...
public class WorkspaceReportRunExecuteViewServiceTests
{
    [Fact]
    public async Task BuildAsyncAllowsEditWhenAdmin()
    {
        ...
        var svc = new WorkspaceReportRunExecuteViewService(userWorkspaceRoleRepository.Object, perms.Object);
