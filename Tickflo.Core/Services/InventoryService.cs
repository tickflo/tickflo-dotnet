...
public class InventoryService : IInventoryService
{
    ...
    public async Task<Inventory> CreateInventoryAsync(int workspaceId, CreateInventoryRequest request)
    {
    ...
    public async Task<Inventory> UpdateInventoryAsync(int workspaceId, int inventoryId, UpdateInventoryRequest request)
    {
