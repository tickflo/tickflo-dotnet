...
public interface IImageStorageService
{
    ...
    public Task<string> UploadUserAvatarAsync(int userId, Stream imageStream);
    ...
    public Task<bool> DeleteUserAvatarAsync(int userId);
    ...
    public Task<string> UploadWorkspaceLogoAsync(int workspaceId, Stream imageStream);
    ...
    /// <param name="workspaceId">The workspace ID</param>
    /// <returns>True if successful</returns>
    public Task<bool> DeleteWorkspaceLogoAsync(int workspaceId);
    ...
    public Task<string> UploadWorkspaceBannerAsync(int workspaceId, Stream imageStream);
    ...
    /// <param name="workspaceId">The workspace ID</param>
    /// <returns>True if successful</returns>
    public Task<bool> DeleteWorkspaceBannerAsync(int workspaceId);
    ...
    public Task<string> UploadDocumentImageAsync(int workspaceId, string documentPath, Stream imageStream);
    ...
    /// <returns>True if successful</returns>
    public Task<bool> DeleteDocumentImageAsync(int workspaceId, string documentPath);
