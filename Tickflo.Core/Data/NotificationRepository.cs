...
public class NotificationRepository(TickfloDbContext db) : INotificationRepository
{
    ...
    public async Task<List<Notification>> ListPendingAsync(string deliveryMethod, int limit = 100)
    {
    ...
    public async Task<List<Notification>> ListByBatchIdAsync(string batchId)
    {
        return await _db.Notifications
